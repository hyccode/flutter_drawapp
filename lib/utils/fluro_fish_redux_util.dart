...
class FluroFishReduxUtils {
  static Page<Object, dynamic> visitor(Page<Object, dynamic> page) {
  ...
  static Widget createPage(Page<Object, dynamic> page, dynamic params) {
    visitor(page);
    return page.buildPage(params);
  }
}
